...
- (void) viewDidLoad
{
	...
	Presence2AppDelegate * appDelegate = [[UIApplication sharedApplication] delegate] ;
	...
	// instantiate the model, retain a reference to it in an ivar, and set that reference to the appDelate's reference as well
	appDelegate.people = people = [[Person personsWithUsernamesInPlist: plistPath] retain] ;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	Person * thePersonClicked = [people objectAtIndex: indexPath.row] ;
	// load the detail view
	UIViewController * detailViewController = [PersonDetailTableViewController viewControllerWithPerson: thePersonClicked] ;
